  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
                      ...
                      <div>
                        ...
                        <Dialog open={isRechargeDialogOpen} onOpenChange={setIsRechargeDialogOpen}>
                          ...
                          <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                              <DialogTitle>Recharger votre solde FCFA</DialogTitle>
                              <DialogDescription>
                                Entrez le montant et votre numéro de téléphone pour le paiement mobile.
                              </DialogDescription>
                            </DialogHeader>
                            <div className="grid gap-4 py-4">
                              <div className="grid grid-cols-4 items-center gap-4">
                                <Label htmlFor="recharge-amount" className="text-right">Montant (F)</Label>
                                <Input
                                  id="recharge-amount"
                                  type="number"
                              ...
                              <div className="grid grid-cols-4 items-center gap-4">
                                <Label htmlFor="phone-number" className="text-right">Téléphone</Label>
                                <div className="col-span-3">
                                  <Input
                                    ...
                                    className="w-full"
                                    placeholder="Ex: 56962433"
                                    disabled={isProcessingPayment}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">
                                    Format: 8 chiffres (ex: 56962433)
                                  </p>
                                </div>
                              </div>
                              <p className="text-xs text-center text-gray-500 dark:text-gray-400">
                                Vous serez redirigé vers CinetPay pour compléter le paiement.
                              </p>
                            </div>
                            <DialogFooter>
                              <Button 
                                type="button" 
                                onClick={handleRechargeZgeg} 
                                disabled={isProcessingPayment || !validatePhoneNumber(phoneNumber) || !rechargeAmount || Number(rechargeAmount) <= 0}
                              >
                                {isProcessingPayment ? (
                                  <>
                                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
      ...
      <Dialog open={isWithdrawalDialogOpen} onOpenChange={setIsWithdrawalDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>Retirer des FCFA</DialogTitle>
            <DialogDescription>
              Entrez le montant en Francs que vous souhaitez retirer.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="withdrawal-amount" className="text-right">Montant (F)</Label>
              <Input
                id="withdrawal-amount"
                type="number"
                placeholder="Ex: 5000"
                // Vous devrez ajouter un état et un gestionnaire pour ce champ
              />
            </div>
             <p className="text-xs text-center text-gray-500 dark:text-gray-400">
                Options de retrait (MoMo, Carte) apparaîtraient ici.
              </p>
          </div>
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsWithdrawalDialogOpen(false)}>Annuler</Button>
            <Button type="button" disabled>Confirmer Retrait</Button>{/* Désactivé pour l'instant */}
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>

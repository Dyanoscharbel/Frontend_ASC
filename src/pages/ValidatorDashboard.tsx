          ...
          <TabsContent value="rules">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Les deux joueurs présents doivent se plaindre. Si l'adversaire ne formule pas de plainte dans les 30 minutes suivant l'heure du match, il est déclaré forfait. Si aucun des deux ne formule de plainte, ils sont déclarés forfait.
                  </p>
                    </div>

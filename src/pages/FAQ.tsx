      ...
      >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Le tournoi est organisé par une association informelle de fans de jeux mobiles, sans entité centralisée ni siège fixe, permettant une organisation flexible et transnationale. Il n'est affilié à aucune entreprise, éditeur ou plateforme tierce, y compris First Touch Games Ltd.
            </p>
          </div>

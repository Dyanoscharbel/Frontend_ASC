          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ASC (AfriK Soccer Cup ) est la première plateforme de tournois Dream League Soccer créée par des Africains, pour les Africains. Notre mission est de développer l'esport en Afrique en offrant une plateforme professionnelle et équitable.
              </p>
            </section>
